...
> Answer: Client Side Routing is great for small applications because you can manipulate the dom without having to 
reload the page. This improves UX and speed of the application.
